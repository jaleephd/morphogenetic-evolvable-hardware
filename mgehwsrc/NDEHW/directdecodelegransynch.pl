...
#		input lines, LUT fn, sync out mux settings & out bus to single
...
# bits 0-3 sets out0,out2,out4,out3 to OFF,S0_YQ,S0_XQ,S0_YQ,S0_XQ
# bits 4-7 sets out1,out5,out6,out7 to OFF,S0_YQ,S0_XQ,S0_YQ,S0_XQ
...
sub decode_bus {
  ...
  my @sliceouttable = ("OFF", "S0_YQ", "S0_XQ", "S1_YQ", "S1_XQ");
